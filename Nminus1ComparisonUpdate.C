...
int Nminus1ComparisonUpdate(unsigned int id){
  ...
  TString dirname = ".";
  TString fullsim_ntuple = "FullSim_Nminus1_plots_invH_8TeVTEST.root";
  ...
  leg1->AddEntry((TObject*)0, "PU, ZTune included","");
  ...
  leg2->AddEntry((TObject*)0, "PU , ZTune incldued","");
  ...
  leg3->AddEntry((TObject*)0,"PU, ZTune included","");
  ...
  leg4->AddEntry((TObject*)0,"PU, ZTune included","");
  ...
  leg5->AddEntry((TObject*)0, "PU, ZTune included","");
  ...
  leg6->AddEntry((TObject*)0, "PU, ZTune included ", "");
  ...
  leg7->AddEntry((TObject*)0,"PU, ZTune included", "");
  ...
  leg8->AddEntry((TObject*)0,"PU, ZTune included" , "");
  ...
  leg9->AddEntry((TObject*)0,"PU, ZTune included " ,"");
  ...
  leg11->AddEntry((TObject*)0, "PU, ZTune included","");
  ...
  leg12->AddEntry((TObject*)0, "PU, ZTune included","");
  //  leg11->AddEntry((TObject*)0, "VBFNLO entries: 152", "");
